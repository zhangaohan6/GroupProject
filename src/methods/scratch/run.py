"""[C] From-scratch (random init) runner.
  python -m src.methods.scratch.run --arch resnet50 --tag res50_ft --epochs 30
"""
...
def main():
    ...
    ap.add_argument("--tag", default="res50_scratch"); ap.add_argument("--epochs", type=int, default=60)
    ...
    m = DeepMethod(a.arch, pretrained=False, data_root=a.data, tag=a.tag)
